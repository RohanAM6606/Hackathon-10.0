...
const domains = [
  {
    id: 1,
    title: "HealthTech",
    desc: "Build innovative healthcare solutions like AI diagnostics, telemedicine platforms, and patient monitoring systems to improve lives.",
  },
  {
    id: 2,
    title: "IoT Systems",
    desc: "Design smart connected systems using sensors, devices, and automation for smarter homes, cities, and industries.",
  },
  {
    id: 3,
    title: "Artificial Intelligence",
    desc: "Develop intelligent systems using machine learning, NLP, and computer vision to solve complex real-world problems.",
  },
  {
    id: 4,
    title: "Innovation & Research",
    desc: "Explore cutting-edge technologies, experiment with new ideas, and build futuristic solutions with strong research backing.",
  },
  {
    id: 5,
    title: "Applied AI (LLMs)",
    desc: "Integrate large language models into real-world applications like chatbots, copilots, and automation tools.",
  },
  {
    id: 6,
    title: "SocioSphere",
    desc: "Create impactful solutions addressing social challenges in education, sustainability, accessibility, and community welfare.",
  },
];
